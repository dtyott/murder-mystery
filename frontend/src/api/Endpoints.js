...
export const RANDOM_ITEM_ENDPOINT = '/api/db/items/new_id';
export const RANDOM_STORE_ENDPOINT = '/api/db/stores/new_id';
...
export const ITEM_ENDPOINT = '/api/db/items';
export const STORE_ENDPOINT = '/api/db/stores';
...
export const CREATE_ITEM_ENDPOINT = '/api/db/create/items';
export const CREATE_STORE_ENDPOINT = '/api/db/create/stores';
...
export const ITEM_ENDPOINTS = [ITEM_ENDPOINT, CREATE_ITEM_ENDPOINT, UPDATE_ITEM_ENDPOINT, RANDOM_ITEM_ENDPOINT]
export const STORE_ENDPOINTS = [STORE_ENDPOINT, CREATE_STORE_ENDPOINT, UPDATE_STORE_ENDPOINT, RANDOM_STORE_ENDPOINT]